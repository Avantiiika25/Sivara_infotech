...
function ProjectCard({
  ...
  return (
    <motion.div
      ...
      className="group relative rounded-2xl overflow-hidden bg-white shadow-md hover:shadow-2xl border border-border h-[400px]"
    >
      <img
        src={image}
        alt={title}
      ...
      <div className="absolute inset-0 p-8 flex flex-col justify-end text-white">
        ...
        <div className="translate-y-12 group-hover:translate-y-0 transition-transform duration-500 ease-out">
          ...
          <div className="h-0 opacity-0 group-hover:h-auto group-hover:opacity-100 transition-all duration-500 overflow-hidden">
            ...
            <Button
              onClick={onViewTour}
              className="w-full bg-white text-primary hover:bg-gray-100 font-semibold transition-all duration-300 group/btn shadow-lg"
            >
