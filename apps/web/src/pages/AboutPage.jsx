...
useEffect(() => {
  const container = document.getElementById("cloudpano-tour");
  ...
  script.src =
    "https://view.sivaraa360studio.com/public/shareScript.js";

  script.async = true;
  script.setAttribute("data-short", "fr6K6w0y1");
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid lg:grid-cols-2 gap-12 items-center">
      ...
      >
        ...
        {/* Tour Card */}
        <div className="relative bg-white rounded-[28px] overflow-hidden shadow-2xl border border-cyan-100 p-2">

          <div className="w-full h-[550px] rounded-3xl overflow-hidden bg-white">
            <iframe
              src="https://view.sivaraa360studio.com/tours/fr6K6w0y1"
              title="Urban Sytes 360 Tour"
              width="100%"
              height="100%"
              style={{
                border: "none",
